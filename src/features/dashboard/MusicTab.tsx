               ...
               <div className="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
                 ...
                 <button
                   ...
                   className="
                     ...
                     active:scale-[0.98]
                     whitespace-nowrap
                     shadow-[0_0_30px_rgba(245,245,0,0.08)]
                   "
                 >
             ...
             <div className="grid grid-cols-2 xl:grid-cols-4 gap-4 mt-8 lg:mt-10">
               ...
               {[
                 ...
                 >
                   ...
                   <h3 className="text-[22px] sm:text-[30px] font-bold text-white">
                     {item.value}
                   </h3>
                 </div>
               ))}
                       ...
                       <div className="flex items-start justify-between gap-4">
                         ...
                         <div className="min-w-0 flex-1">
                           ...
                           <div className="flex items-center gap-3 mt-3 flex-wrap">
                             ...
                             <span className="px-3 h-[24px] flex items-center bg-white/[0.03] border border-white/[0.05] rounded-[3px] text-[10px] uppercase tracking-[0.15em] text-white/50">
                               {release.type}
                             </span>
                         ...
                         <button className="w-8 h-8 flex items-center justify-center rounded-[3px] hover:bg-white/[0.03] text-white/40 hover:text-white transition-all">
